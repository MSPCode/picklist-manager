...
export default class LookupComponent extends LightningElement {
    @api objectName = 'FieldDefinition';
    @api fieldName = 'EntityDefinition.QualifiedApiName';
    @api ObjectToSearch = 'Main__c'
    @api selectRecordId = '';
    ...
    searchField(event) {
        ...
        getResults({ ObjectName: this.objectName, ObjectToSearch: this.ObjectToSearch, fieldName: this.fieldName, value: currentText  })
        .then(result => {
            console.log(result);
