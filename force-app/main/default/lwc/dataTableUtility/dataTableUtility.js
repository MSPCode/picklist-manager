...
export default class DataTableUtility extends LightningElement {
    ...
    @api tableHeightMapping = {
                        '10': 300, // Example height for 5 rows
                        '25': 750, // Example height for 10 rows
                        '50': 1500, // Example height for 15 rows
                        '75': 2250, // Example height for 20 rows
                        '100':3000, // Example height for 20 rows
    ...
    handleRecordsPerPage(event){
        ...
        this.setRecordsOnPage();
            ...
            // Update table height based on the new page size
        if (this.tableHeightMapping[this.pageSize]) {
            this.tableHeight = this.tableHeightMapping[this.pageSize];
        } else {
            // If no specific height is defined for the current page size, use the default height
